...
OFFICIAL_RSS_FEEDS: list[tuple[str, str, str]] = [
    ...
    ("Applied Materials", "https://www.appliedmaterials.com/company/news/rss", "rss"),
    ("Tokyo Electron", "https://www.tel.com/news/rss", "rss"),
    ("LAM Research", "https://www.lamresearch.com/news/feed/", "rss"),
    ("KLA Corporation", "https://ir.kla.com/news-releases/rss", "rss"),
    ("Teradyne", "https://www.teradyne.com/news/rss", "rss"),
    ("Advantest", "https://www.advantest.com/news/rss", "rss"),
